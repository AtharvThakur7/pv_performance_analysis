...
# def visualize_performance(csv_path='output/combined_data.csv', output_path='output/final_pr_graph1.png'):
...
#     df['Budget_PR'] = 73.9  # Initial value
...
#     # Add legend for GHI color coding manually
...
#     # Bottom-right text box for average PRs
#     stats_days = [7, 30, 60, 90]
#     stat_text = "\n".join([f"Last {d}d Avg PR: {df['PR'].tail(d).mean():.2f}" for d in stats_days if len(df) >= d])
...
# # Test the function when this file is executed standalone
